<nav class="NavbarPrincipale">
    ...
    <div class="opzioni">
        ...
        <button type="button" class="btn btn-outline-info">Assistenza</button>
        ...
        <div class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a class="dropdown-item ComandiUser" href="{{route('impostazioni')}}">
                ...
                <li>
                    <a class="dropdown-item ComandiUser" href="#" onclick="
