<div class="row">
    @if (isset($filteredDettaglio[0]) && $filteredDettaglio[0]['nome'])
            ...
            <select id="operator-select" wire:change="OperatoreSelezionato($event.target.value)">
                ...
                @foreach ($filteredDettaglio as $singoloDettaglio)
                    <option value="{{ $singoloDettaglio->id }}">
                        {{ $singoloDettaglio->cognome}} {{ $singoloDettaglio->nome}}
                    </option>
                @endforeach
            </select>
        </div>    
        <div class="col-2 AddPeople">
            <a href="#" wire:click.prevent="toggleFormAdd">
            ...
            <a href="#" wire:click.prevent="toggleFormEdit(document.getElementById('operator-select').value)">
            ...
            <a href="#" wire:click="delete(document.getElementById('operator-select').value)">
    ...
    @elseif (isset($filteredDettaglio[0]) && $filteredDettaglio[0]['DVR'])
        <p>funziona</p>
    @endif        
</div>
